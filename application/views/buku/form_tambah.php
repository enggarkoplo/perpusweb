...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>buku/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">

        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                <a href="<?= base_url() ?>buku" class="btn btn-md btn-circle btn-dark">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card border-bottom-dark shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <div id="img">
                                <img src="<?= base_url() ?>assets/icon/book.png" id="outputImg" width="200" maxheight="300">
                            </div>
                            <div id="pdf">
                                <embed src="<?= base_url() ?>assets/icon/book.png" id="outputPdf" width="300" height="400" type="application/pdf">
                            </div>
                        </center>
                        <br>
                        <!-- foto -->
