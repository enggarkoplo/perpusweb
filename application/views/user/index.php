                        ...
                        <tbody style="cursor:pointer;" id="tbody">
                            ...
                            foreach ($user as $u) : ?>
                                <tr>
                                    ...
                                    <td onclick="detail('<?= $u->id_user ?>')"><img style="border-radius: 5px;" src="assets/upload/pengguna/<?= $u->foto ?>" alt="" width="75px"></td>
                                    ...
                                    <td onclick="detail('<?= $u->id_user ?>')">
                                        ...
                                        <?php if ($u->level === 'Petugas') {
                                            echo 'siswa';
                                        } else if ($u->level === 'Administrasi') {
                                            echo 'Administrasi';
                                        }
                                        ?>
                                    </td>
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>user/ubah/<?= $u->id_user ?>" class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="#" onclick="konfirmasi('<?= $u->id_user ?>')" class="btn btn-circle btn-danger btn-sm">
