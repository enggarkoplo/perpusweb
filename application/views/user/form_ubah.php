                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group"><label>Level</label>
                                    <select name="level" class="form-control">
                                        <option value="Administrasi" <?php if ($u->level == "Administrasi") : ?> Selected <?php endif; ?>>Administrasi</option>
                                        <option value="Petugas" <?php if ($u->level == "Petugas") : ?> Selected <?php endif; ?>>Siswa</option>
                                        <option value="Kepala" <?php if ($u->level == "Kepala") : ?> Selected <?php endif; ?>>Kepala</option>
                                    </select>
                                </div>
