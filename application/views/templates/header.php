...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url(); ?>assets/icon/logo-smkn1palu.png">

    <title>SIPANDAI | <?= $title ?></title>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>home">
                <div class="sidebar-brand-icon ">
                    <img src="<?= base_url(); ?>assets/icon/logo-smkn1palu.png" width="50">
                </div>
                <div class="sidebar-brand-text mx-3 ">SIPANDAI</div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 font-weight-bold" id="namaP"><?= $this->session->userdata('username') ?></span>
