                            ...
                            foreach ($pinjam as $p) : ?>
                                <tr>
                                    ...
                                    <?php if ($this->session->userdata('level') == 'Administrasi') : ?>
                                        ...
                                        <td>
                                            <a href="<?= base_url() ?>peminjaman/detail/<?= $p->id_pinjam ?>" class="btn btn-primary btn-sm btn-circle"><i class="fa fa-eye"></i></a>
                                            <a href="#" onclick="konfirmasi('<?= $p->id_pinjam ?>')" class="btn btn-circle btn-danger btn-sm">
