...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>peminjaman/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">

        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                <a href="<?= base_url() ?>peminjaman" class="btn btn-md btn-circle btn-dark">
        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tglpinjam" readonly class="form-control" value="<?= $tglsekarang ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tglkembali" readonly class="form-control" value="<?= $tglplus3 ?>">
                                </div>
                            </div>
                ...
                <div class="card border-bottom-dark shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <center>
                                    <img style="border-radius: 5px;" src="<?= base_url() ?>assets/upload/anggota/user.png" id="preview" width="75" maxheight="300">
                                </center>
                            </div>
                            <div class="col-lg">
                                <p id="namaL">-</p>
            ...
            <div class="col-lg">
                <div class="card border-bottom-dark shadow mb-4">
                    <div class="card-header py-3 d-sm-flex justify-content-between bg-dark">
