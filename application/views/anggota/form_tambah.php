...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>anggota/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Nama Lengkap</label>
                                <input class="form-control" name="nmlengkap" type="text" placeholder="" autofocus>
                            </div>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-0">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group"><label>Tgl Lahir</label>
                                    <input class="form-control" name="tgllahir" id="datepicker" type="text" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <!-- umur -->
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card border-bottom-dark shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <div id="img">
                                <img src="<?= base_url() ?>assets/icon/user.png" id="outputImg" width="200" maxheight="300">
                            </div>
                            <div id="pdf">
                                <embed src="<?= base_url() ?>assets/icon/user.png" id="outputPdf" width="300" height="400" type="application/pdf">
                            </div>
                        </center>
                        <br>
                        <!-- foto -->
