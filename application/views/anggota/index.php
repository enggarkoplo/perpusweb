                        ...
                        <tbody style="cursor:pointer;" id="tbody">
                            ...
                            foreach ($anggota as $a) : ?>
                                <tr>
                                    ...
                                    <td onclick="detail('<?= $a->id_anggota ?>')"><img style="border-radius: 5px;" src="assets/upload/anggota/<?= $a->foto ?>" alt="" width="75px"></td>
                                    ...
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>anggota/ubah/<?= $a->id_anggota ?>" class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="#" onclick="konfirmasi('<?= $a->id_anggota ?>')" class="btn btn-circle btn-danger btn-sm">
