...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        ...
        <a href="<?= base_url() ?>profile/ubah/<?= $this->session->userdata('id_user') ?>" class="btn btn-sm btn-primary btn-icon-split">
                ...
                <center>
                    <div class="col-lg-12 mb-4">
                        <div class="box-circle bg-primary posisi">
                            <img class="img-profile rounded-circle" id="outputImg" width="100%" height="100%" src="<?= base_url() ?>assets/upload/pengguna/user.png">
                        </div>
                        <br>
