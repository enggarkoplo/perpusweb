...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="<?php if ($this->session->userdata('level') == 'Administrasi' || $this->session->userdata('level') == 'Kepala') : ?> col-xl-6 col-md-6 mb-4 <?php else : ?> col-xl-12 col-md-12 mb-4<?php endif ?>" id="top3">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color: #A3ABAE;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <center>
                                <a href="<?= base_url() ?>buku" class="btn btn-success btn-md">
                                    <i class="fa fa-eye"></i>
                                    Lihat semua buku
                                </a>
                            </center>
            ...
            <div class="col-xl-6 col-md-6 mb-4" id="top3anggota">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
                        <h6 class="m-0 font-weight-bold border-0 text-white">Siswa yang sering pinjam buku</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <center>
                                    <a href="<?= base_url() ?>peminjaman" class="btn btn-primary btn-md">
                                        <i class="fa fa-eye"></i>
