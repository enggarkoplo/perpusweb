                        ...
                        <tbody id="tbody">
                            ...
                            foreach ($penerbit as $p) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="#" data-toggle="modal" data-target="#formU" onclick="ambilData('<?= $p->id_penerbit ?>')" class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="#" onclick="konfirmasi('<?= $p->id_penerbit ?>')" class="btn btn-circle btn-danger btn-sm">
