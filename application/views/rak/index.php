                        ...
                        <tbody id="tbody">
                            ...
                            foreach ($rak as $r) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="#" data-toggle="modal" data-target="#formU" onclick="ambilData('<?= $r->id_rak ?>')" class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="#" onclick="konfirmasi('<?= $r->id_rak ?>')" class="btn btn-circle btn-danger btn-sm">
