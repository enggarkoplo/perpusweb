                        ...
                        <tbody id="tbody">
                            ...
                            foreach ($pengadaan as $p) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>pengadaan/ubah/<?= $p->id_pengadaan ?>" class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="#" onclick="konfirmasi('<?= $p->id_pengadaan ?>','<?= $p->jml ?>','<?= $p->id_buku ?>')" class="btn btn-circle btn-danger btn-sm">
