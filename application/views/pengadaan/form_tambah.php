...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>pengadaan/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">


        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                <a href="<?= base_url() ?>pengadaan" class="btn btn-md btn-circle btn-dark">
                ...
                <div class="card border-bottom-dark shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <center>
                                <img id="preview" width="200px" src="<?= base_url() ?>assets/upload/buku/book.png" alt="">
                            </center>
