                        ...
                        <tbody id="tbody">
                            ...
                            foreach ($kategori as $k) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="#" data-toggle="modal" data-target="#formU" onclick="ambilData('<?= $k->id_kategori ?>')" class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="#" onclick="konfirmasi('<?= $k->id_kategori ?>')" class="btn btn-circle btn-danger btn-sm">
